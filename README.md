# Petclinic OpenAPI Specification
[![Build Status](https://travis-ci.org/pkujala/demo.svg?branch=master)](https://travis-ci.org/pkujala/demo)
...
6. If you did everything correct, https://pkujala.github.io/demo/ will lead to your new docs
...
- Documentation(ReDoc): https://pkujala.github.io/demo/
- SwaggerUI: https://pkujala.github.io/demo/swagger-ui/
- Look full spec:
    + JSON https://pkujala.github.io/demo/swagger.json
    + YAML https://pkujala.github.io/demo/swagger.yaml
- Preview spec version for branch `[branch]`: https://pkujala.github.io/demo/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://pkujala.github.io/demo/ with url from the message: `Server started <url>`
